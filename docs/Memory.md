...
- Verified on 2026-08-27: Ruff, strict mypy, 15 pytest tests, Alembic clean upgrade, ESLint, TypeScript, Next.js production build, npm audit (zero vulnerabilities), Docker PostgreSQL readiness, and API/web HTTP smoke checks all passed.
